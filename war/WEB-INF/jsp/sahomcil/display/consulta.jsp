...
<div id="ModuloModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="ModuloModalLabel" aria-hidden="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> <h2>Designar Hora al Modulo</h2>
        <h6><font color="red">(Ejemplo= 09:00)</font></h6>
           <h4 id="myModalLabel">Desde:</h3><input type="text" size="5" maxlength="5"value="09:00" name="desde"><br></br>
           
            <h4 id="myModalLabel">Hasta:</h3><input type="text" size="5" maxlength="5"value="10:00" name="hasta"><br></br>
                </div>
                        ...
                        <table class="table table-hover table-bordered table-condensed">
                            ...
                            <tbody>
                                <tr class="success">
                                    ...
                                    <td ><a href="#ModuloModal" role="button" class="btn" data-toggle="modal">Modulo 1</a><br>
                                        <br>
                                ...
                                <tr class="success">
                                   <td ><a href="#ModuloModal" role="button" class="btn" data-toggle="modal">Modulo 2</a><br>
                                        <br>
                                ...
                                <tr class="success">
                                    <td ><a href="#ModuloModal" role="button" class="btn" data-toggle="modal">Modulo 3</a><br>
                                        <br>
                                ...
                                <tr class="success">
                                   <td ><a href="#ModuloModal" role="button" class="btn" data-toggle="modal">Modulo 4</a><br>
                                        <br>
