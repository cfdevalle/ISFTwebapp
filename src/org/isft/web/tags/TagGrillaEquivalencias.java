...
import org.isft.logic.collection.CollectionMateriaEquivalencias;
    ...
    public int doStartTag() throws JspException {
            ...
            try {
               // System.out.println("ENTRO AL TAG GRILLA codigo carrera es "+cod_carrera);
                ...
                CollectionMateriaEquivalencias coleccion=new CollectionMateriaEquivalencias();
                ...
                for(int i=0;i<vectorMaterias.size();i++){
                    ...
                    tabla+="<td><table class='table table-condensed'>";
                                ...
                                tabla+="<tr class='success'><td>"+equivalencia.getCod_materia_d()+"-"+equivalencia.getCod_carrera_d()+"</td>";
