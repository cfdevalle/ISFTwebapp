...
public class TagGrillaInscripcionMaterias extends TagGrilla {
        ...
        try {
            ...
            if (vec.isEmpty()) {
                tabla += "<tr class=\"error\">"
                      +  "<td colspan=\"6\" rowspan=\"6\"><img src=\"static/images/sim/inscribirse_a_materias.jpg\" width=\"100%\" height=\"100%\"></td>"
                      +  "</tr>";
                ...
                tabla += "<tfoot border=\"0\">"
                      ...
                      +     "<td colspan=\"1\">"
                      +         "<div align=\"right\" valign=\"bottom\">"
                      +             "<a href=\"#abmSimInsert\" data-toggle=\"modal\" class=\"btn btn-primary\"><i class=\"icon-pencil icon-white\"></i> Inscribirse</a>"
                      +         "</div>"
                      +     "</td>"
                      +  "</tfoot>";
            }     
