...
public class CollectionEquivalencias implements org.isft.logic.AccessInterface{
    ...
    public Vector select(HashMap parameters) throws Exception {
       ...
       try{
          rs = am.execute("select m.nombre, e.* from equivalencias e, materia m where e.cod_carrera_o="+codigoC+" and e.cod_materia_o="+codigoM+" and e.cod_carrera_d=m.cod_carrera and e.cod_materia_d=m.cod_materia");
       ...
       while (rs.next()){
           ...
           equivalencias.setNombre_materia(nombre);
