                    ...
                    <div class="well">
                            <table>
                                <tr>
                                    ...
                                    <td style=" width: 800px;">   <H2>I.S.F.T. Nº 179 Dr. Carlos Pellegrini</h2>
                                        
                                          <p class="muted">Excelencia Académica - Solidez Institucional - Salida Laboral</p>
                                    </td>
                ...
                <div class="span2">
                    ...
                    <div class="tabbable tabs-left">
                     <ul class="nav nav-tabs"> 
                         ...
                         <li class="active"><a href="javascript:goPage(6001)">Visión y Misión</a></li>
                         ...
                         <li class="divider"></li>
                         <li><a href="javascript:goPage(6009)">Administración General</a></li>
                         <li><a href="javascript:goPage(6010)">Servicios Gastronimicos</a></li>
                         <li><a href="javascript:goPage(6011)">Industria Textil</a></li>
                         <li><a href="javascript:goPage(6012)">Instalación y Mantenimiento</a></li>
                         ...
                         <li><a href="javascript:goPage(6018)">Automatización y Robotica</a></li>
